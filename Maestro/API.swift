...
class API {
	...
	public func getLesson(numbered lessonNumber: Int) -> Promise<Lesson> {
		...
		let index = 1
		let cards = [
			LessonContent(text: "The staff is a tool to graphically represent music. It consists of 5 lines and 4 spaces on which to plot notes. Each line or space represents a letter in the musical alphabet.", imageURL: "card_images/lesson_1/card_1"),
			LessonContent(text: "There are 7 letters that make up the musical alphabet: A, B, C, D, E, F, G. Progressing through all 7 notes in order makes a scale. The letters restart after G, so the note after G is always A. The simplest scale is the C Major Scale: C, D, E, F, G, A, B, C", imageURL: "card_images/lesson_1/card_2"),
			LessonContent(text: "The clefs determine where the notes go on the staff. The treble clef (or “G” clef) looks like a cursive G, and denotes a G on the second line from the bottom: the “curl” of the G curls around the second line. The bass clef (or “F” clef) looks like a stylized F, with the two dots, or “lines”, of the F hugging the second line from the top of the staff", imageURL: "card_images/lesson_1/card_3")
